...
CREATE TABLE IF NOT EXISTS `vidaplus`.`anamnese` (
  ...
  `anotacoesRespiratorias` VARCHAR(200) NULL,
  ...
  `anotacoesAlergiasMedicamento` VARCHAR(200) NULL,
  `alergiaAlimento` TINYINT NULL,
  `anotacoesAlergiaAlimento` VARCHAR(200) NULL,
  `tratamentoAtual` TINYINT NULL,
  `anotacoesTratamento` VARCHAR(200) NULL,
  `marcaPasso` TINYINT NULL,
  `medicamentoContinuo` TINYINT NULL,
  `anotacoesMedicamentoContinuo` VARCHAR(200) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
